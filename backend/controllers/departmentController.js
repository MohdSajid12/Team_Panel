...
export const getDepartment = async(req,res) =>{
     try{
        ...
        return res.status(500).json({success : false , message : "server error in get department"})
     }
}
export const addDepartment = async (req ,res) =>{
    try{
        ...
        return res.status(500).json({success : false , message : "server error in add department"})
    }
}
